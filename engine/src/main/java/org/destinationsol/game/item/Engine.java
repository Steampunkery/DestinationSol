...
public class Engine implements SolItem {
    ...
    public static class Config {
        ...
        private Config(String displayName, int price, String desc, float rotAcc, float thrust, float maxRotSpd, boolean big,
        ...
        public static Config load(String engineName, OggSoundManager soundManager, EffectTypes effectTypes, GameColors cols) {
            ...
            float thrust = rootNode.getFloat("thrust");
            ...
            return new Config(null, 0, null, rotAcc, thrust, maxRotSpd, big, workSoundSet, null, effectConfig, engineName);
        }
    }
}
